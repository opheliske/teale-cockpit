...
// recherche, tri, état vide) — voir (client)/kits-communication —
...
export default function CsmKitsPage() {
  ...
  // l'autre. La recherche (q) et le tri restent partagés.
  ...
  return (
    <div className="px-9 py-8">
      <div className="mx-auto max-w-[1280px]">
        ...
        {/* Compteur de la rubrique + tri + Ajouter */}
        ...
        {/* Panneau de la rubrique active (CRUD conservé sur chaque carte) */}
        {visible.length === 0 ? (
...
// FacetGroup/FacetOption). Réutilise FacetOption et la même dimension de filtre.
