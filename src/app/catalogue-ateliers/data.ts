...
export const workshops: Workshop[] = [
  {
    ...
    programme: [
      ...
      },
      {
        ...
        items: [
          "Par où commencer : mini recette pour démarrer",
          "Les apports des TCC",
        ],
      },
      {
        ...
        items: [
          "Les différents professionnels & thématiques",
  ...
  {
    id: "premiers-gestes-sante-mentale",
    ...
    programme: [
      {
        title:
          "Détecter et accompagner pour prévenir l'apparition d'un trouble",
        items: [
          "Savoir détecter les signaux faibles",
          "Reconnaître qu'un trouble s'installe",
          "Focus sur trois troubles au choix : crise anxieuse, dépression, burnout, crise suicidaire ou addictions",
        ],
      },
      {
    ...
    programme: [
      ...
      },
      {
        ...
        items: [
          ...
          "Savoir prendre soin de soi et demander de l'aide",
        ],
      },
    ],
    targetAudience: [
    ...
    programme: [
      {
        ...
        items: [
          ...
          "Comment notre cerveau traite l'information ?",
        ],
      },
      {
        title: "Nos émotions",
      ...
      },
      {
        ...
        items: [
          ...
          "La recette : la communication non violente",
        ],
      },
    ],
    targetAudience: [
  ...
  },
  {
    ...
    objectives: [
      ...
      "Être attentif à soi pour prévenir le burnout",
    ],
    programme: [
      {
      ...
      {
        title: "Stratégie de prévention",
        items: ["Collective", "Individuelle"],
      },
    ...
    programme: [
      {
        ...
        items: [
          "Exercice : se présenter à travers un référent",
          "Définition",
        ],
      },
      {
        ...
        items: [
          "Les 3 principes de l'approche basée sur les forces",
          "Et au travail ?",
        ],
      },
      {
  ...
  },
  {
    ...
    programme: [
      ...
      {
        title:
          "Les techniques et outils pour muscler son optimisme au quotidien",
        items: [
          "Ressentir et cultiver les émotions positives",
  ...
  },
  {
    ...
    programme: [
      ...
      {
        title:
          "Les 4 piliers de la cohésion d'équipe : construire un plan d'actions qui vous ressemble",
        items: [
          "La collaboration",
          "L'entraide",
          "La communication",
    ...
    targetAudience: [
      ...
      "Vous souhaitez renforcer l'entraide et la cohésion au sein de l'entreprise ou d'une équipe spécifique.",
    ],
  },
  {
    id: "assertivite",
    ...
    programme: [
      ...
      {
        title:
          "L'affirmation de soi dans le milieu professionnel — exercices pratiques",
        items: [
  ...
  },
  {
    ...
    programme: [
      ...
      {
        title:
          "Rendre ses enfants « heureux » et les accompagner dans leurs difficultés",
    ...
    targetAudience: [
      ...
      "Vous souhaitez promouvoir une culture d'entreprise inclusive et bienveillante envers les familles pour réduire le stress et augmenter le bien-être.",
    ],
  },
  {
    id: "maladie-chronique",
    title: "Maladie chronique : sensibiliser pour plus d'inclusion",
    subtitle: "Inclusion",
    themeId: "resilience",
    duration: "1h",
    objectives: [
    ...
    programme: [
      ...
      },
      {
        ...
        items: [
          "4 outils pour agir pour une meilleure compréhension et inclusion",
        ],
      },
    ],
    targetAudience: [
  ...
  {
    id: "handicap-travail",
    title: "Handicap au travail : sensibiliser pour plus d'inclusion",
    subtitle: "Inclusion",
    themeId: "resilience",
    duration: "1h",
    objectives: [
  ...
  },
  {
    ...
    programme: [
      { title: "Le processus de changement" },
      {
        ...
        items: [
          "Courbe de deuil",
          "Préoccupations face au changement",
          "Comportements",
        ],
      },
      {
        title:
          "Accompagner le changement : le facteur humain, facteur de réussite",
        items: [
  ...
  },
  {
    ...
    programme: [
      ...
      },
      {
        ...
        items: [
          "Booster son optimisme",
          "Cercles d'influences et de préoccupations",
        ],
      },
    ...
    programme: [
      ...
      },
      {
        ...
        items: [
          ...
          "S'appuyer sur ses forces / capacités pour booster sa confiance en soi",
        ],
      },
      {
        title:
          "Maintenir une énergie positive en se ressourçant et en récupérant",
      },
    ],
    targetAudience: [
      "Les données teale montrent les facettes basses suivantes : capacité à faire face, capacité d'adaptation.",
  ...
  },
  {
    ...
    targetAudience: [
      "Vous avez connaissance de comportements addictifs au sein de l'entreprise (tabac, consommation d'alcool…).",
      "Vous souhaitez sensibiliser les collaborateurs à l'occasion du mois sans tabac ou du dry january.",
      "Vos collaborateurs aimeraient arrêter certains comportements (réseaux sociaux par exemple).",
    ],
  },
];
